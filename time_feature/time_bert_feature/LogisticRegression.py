...
if __name__ == "__main__":
    ...
    feat_pooled = joblib.load('./data/bert_feat_utt.pkl')
    ...
    for val_ in val:
        ...
        clf = make_pipeline(StandardScaler(), LogisticRegression(random_state=100, max_iter=1000, multi_class = 'multinomial', n_jobs = -1, class_weight= {0: 1/counter[0], 1: 1/counter[1]}))
